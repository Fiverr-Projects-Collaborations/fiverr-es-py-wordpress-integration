		...
		'analysis'                         => array(
			'analyzer'   => array(
                ...
                'synonym' => array(
                    ...
                    'filter' => array('synonym','ewp_word_delimiter', 'lowercase', 'stop', 'ewp_snowball')
                ),
                //anegi end of new analyzer
				'ewp_lowercase'    => array(
					'type'      => 'custom',
					'tokenizer' => 'keyword',
			...
			'filter'     => array(
				...
				'stop_w' => array(
                    'type' => 'stop',
                    'stopwords' => array('_italian_','_english_')
                ),
